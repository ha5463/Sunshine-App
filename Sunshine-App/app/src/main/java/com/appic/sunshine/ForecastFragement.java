...
public class ForecastFragement extends Fragment {
    ...
    private void updateWeather(){
        Log.v("REFRESH" , "Forecast JSON String: " );
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mForecastAdapter =
                new ArrayAdapter<String>(
                        ...
                        R.layout.list_items_forecast, // The name of the layout ID.
                        R.id.list_item_forecast_textview, // The ID of the textview to populate.
                        new ArrayList<String> ());  //Forecast Data as List not Array
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        private String formatHighLows(double high, double low) {
            ...
            String unit = shared.getString(getString(R.string.pref_unit_key),getString(R.string.pref_unit_default));
